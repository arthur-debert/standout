...
pub fn tabular_derive_impl(input: DeriveInput) -> Result<TokenStream> {
    ...
    let expanded = quote! {
        impl ::outstanding::tabular::Tabular for #struct_name {
            fn tabular_spec() -> ::outstanding::tabular::TabularSpec {
                ::outstanding::tabular::TabularSpec {
                    columns: vec![
                        #(#column_tokens),*
                    ],
                    decorations: ::outstanding::tabular::Decorations {
