...
pub title: String,  // Generates: -t, --title

#[resource(arg(short = 's', long))]
pub status: String,  // Generates: -s, --status

#[resource(arg(long = "desc"))]
pub description: String,  // Generates: --desc (no short)
```

The `short` and `long` options work exactly like clap's `#[arg]` attribute.
...
pub struct Task {
    ...
    #[resource(arg(short, long), value_enum)]
...
| `arg(...)` | CLI argument options | `#[resource(arg(short, long))]` |
